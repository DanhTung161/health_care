...
import BillingSettlementPanel from "@/components/admin/BillingSettlementPanel";
import CashierReconciliation from "@/components/admin/CashierReconciliation";
import InternalInvoicePreview from "@/components/admin/InternalInvoicePreview";
...
type Detail = {
  ...
  totals: { vatAmount: number; totalPatientPayable: number; amountPaid: number; balanceDue: number; refundDue: number; paymentStatus: PaymentStatus; billingStatus: string; closedBy: { name: string } | null; closedAt: string | null };
};
